...
\begin{abstract}
	...
	Einige Fragen, mit denen wir uns beschäftigen:
%	\begin{itemize}
%		\item Primzahlen, Hauptsatz der Arithmetik.
%		\item ganzzahlige Lösungen von Gleichungen, zum Beispiel
%		\begin{gather}
%		12x + 15y = 6 \\
%		x^2 + y^2 = z^2
%		\end{gather}
%		\item Kongruenzen: Gibt es eine ganze Zahl $z$, sodass $z^2 - 5$ durch $7$ teilbar ist?
%		\item Aufbau des Zahlsystems $\NN \subseteq \ZZ \subseteq \QQ \subseteq \RR \subseteq \CC$.
%		\item Eigenschaften bestimmter Zahlen: Warum ist $\sqrt{2}$ irrational, warum sind $\pi = 3.14159\dots$ oder $e = 2.71\dots$ transzendent?
%	\end{itemize}
