...
\begin{beispiel}[{name=[Räume konstruiert als Quotienten]},label=bsp:konst-top]
	...
	\begin{enumerate}[(i)]
		...
		\]
		$\mathbb{R}P^n$ mit der Quotiententopologie bezüglich $q$ heißt der \Index{reell projektive Raum} der Dimension $n$. Er ist eine $n$-Mannigfaltigkeit (siehe \cref{bsp:diff_mfkt} \cref{enum:RPn_mfkt}).
...
\begin{beispiel}[{name=[differenzierbare Mannigfaltigkeiten]},label=bsp:diff_mfkt]
