...
\begin{lemma}[{name=[Bijektion $G$-inv. Metriken und $\rho(H)$-inv. Skalarprodukte]}]
...
\begin{beweis}
	...
	In den Übungen wird gezeigt, dass $g=(g_q)_{q \in M^n}$ eine differenzierbare Metrik auf $M^n$ ist.\todo{haben wir das wirklich?}
\end{beweis}
...
\begin{korollar}[{name=[Bijektion zw. Metriken auf Quotient und $\Ad(H)$-inv. Skalarprodukten auf Komplement]}]
	Sei $\sfrac{G}{H}$ ein homogener Raum.
	Dann existiert eine Bijektion zwischen
	\begin{itemize}
...
\begin{bemerkung*}[{name=[Eindeutigkeit des Komplements]}]
	...
	In den Übungen wird $\sfrac{G}{H}$ ein \enquote{kanonisches} Komplement zugeordnet.\todo{einarbeiten}
\end{bemerkung*}
