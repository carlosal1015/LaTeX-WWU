...
\begin{lemma}[{name=[Existenz schöner Skalarprodukte und biinvarianter Metriken]}]
...
\begin{lemma}[{name=[Exponentialabbildung surjektiv für kompakte und zusammenhängend]}]
...
\begin{lemma}[{name=[Eindeutigkeit der maximalen abelschen Unteralgebra]}]
...
\begin{beweis}
	...
	In den Übungen wird gezeigt, dass ein $\overline{v} \in \mathfrak{t}$ existiert mit $\overline{\set*{\exp(s \overline{v}) \given s \in \mathbb{R}}} = T$.\todo{einarbeiten}
	Wir zeigen nun 
	\[
