...
\end{align}
Einen Homomorphismus $\Phi \colon G \to \GL(n,\mathbb{K})$ nennt man \bet{reelle}\index{Darstellung!reelle} bzw. \bet{komplexe Darstellung}\index{Darstellung!komplexe} von $G$.\todo{RevChap 1} 
($\Phi_0(G)\equiv E_n$)
