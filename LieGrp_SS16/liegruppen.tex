...
\begin{beweis}
    \begin{enumerate}[(1)]
		...
		Die Abbildung $\Phi$ ist außerdem surjektiv nach \autoref{lem:1213}, denn eine offene Umgebung von $e$ liegt im Bild und $\Phi$ ist ein Homomorphismus.\todo{RevChap 1}\qedhere
    \end{enumerate}
\end{beweis}
