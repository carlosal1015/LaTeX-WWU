...
\begin{korollar}
    ...
    \begin{enumerate}[1)]
        \item Ist $\Phi \colon \tilde{G} \to G$ eine Überlagerung von Liegruppen, so ist $\tilde{\Gamma} = \ker \Phi$ eine diskret Untergruppe von $Z(G)$.\marginnote{Zentrum von $\tilde{G}$}
