...
\begin{beweis}
	...
	Es gilt 
	\begin{align}
		\tilde{c}'(t) = \enbrace*{\mathd L_{c_v(t_0)}}_{c_v(t)}  \cdot \hspace{-1em}\Underbrace{\diffd{}{t} c_v(t)}{= X_v \enbrace*{c_v(t)} = \enbrace*{\mathd L_{c_v(t)}} \cdot v} \hspace{-1em}= \enbrace*{\mathd L_{c_v(t_0) \cdot c_v(t)}}_e \cdot v = X_v \enbrace*{\tilde{c}(t)}
	\end{align}
	Somit ist $\tilde{c}(t)$ wieder eine Integralkurve von $X_v$ und beide Behauptungen folgen.
	Man nennt die Kurve $(c_v(t))_{t \in \mathbb{R}}$ auch \Index{Einparameteruntergruppe} von $G$.\todo{RevChap 1}
\end{beweis}
...
\begin{beweis}
	...
	denn
	\begin{align}
		\diffd{}{t}\Big|_{t=t_0} \psi_t (g,v) = \diffd{}{t}\Big|_{t=t_0} \enbrace[\big]{g \cdot \exp(tv),v} = \enbrace*{\diffd{}{t}\Big|_{t=t_0} g \cdot \exp(tv),0} &= (\mathd L_g)_{c_{tv}(1)} \cdot \diffd{}{t}\Big|_{t=t_0} c_{tv}(1) \\
