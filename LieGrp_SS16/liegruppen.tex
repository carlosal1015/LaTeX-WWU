...
\begin{beispiel*}[{name=[spezielle orthogonale Gruppe]}]
	...
	\]
	gilt.
	Wir erhalten für eine ONB $\set*{b_1, \ldots ,b_N}$ von $\mathfrak{so}(n)$, $N=\frac{1}{2}(n-1)n$\todo{das stimmt noch nicht so ganz, es sollte $\mathcal{B}(X,Y)=(n-2) \tr(XY)$ sein}
	\begin{align}
