...
\begin{beispiel*}[{name=[homogene Räume]},label=bsp:homSpaces]
	...
	\begin{enumerate}[1)]
		...
		\item Die unitäre Gruppe $\Un(n) = \SO(2n) \cap \Mat(n,\mathbb{C})$\marginnote{die Schreibeweise als Schnitt wurde in Aufgabe 11 gezeigt} operiert ebenfalls transitiv auf $S^{2n-1}$.
