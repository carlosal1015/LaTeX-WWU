...
\mapdef{h \cdot \mu_0 \colon \mathfrak{g} \times \mathfrak{g}}{\mathfrak{g}}{\enbrace*{\overline{X}, \overline{Y}}}{h \benbrace*{h^{-1} \overline{X}, h^{-1} \overline{Y}}}{}
wobei $\benbrace*{\cdot ,\cdot }= \mu_0$ \enquote{die} Lieklammer auf $\mathfrak{g}$ ist.
Beobachtung
\begin{itemize}
	\item $h \cdot \mu_0 (\overline{X},\overline{Y}) = - (h \mu_0) \enbrace*{\overline{Y},\overline{X}}$
