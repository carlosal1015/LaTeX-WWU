...
\begin{lemma}
	Es existiert ein kanonisches Komplement $\mathfrak{g} = \mathfrak{h} \oplus \mathfrak{m}$,\marginnote{fast effektiv = effektiv bis auf diskreten Normalteiler} das ohne Riemannsche Metrik auf $H$ definiert werden kann, falls $G$ (fast) effektiv auf $\sfrac{G}{H}$ operiert.
\end{lemma}
\begin{beweis}
