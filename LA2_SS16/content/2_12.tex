...
\begin{bemerkung}
	...
	Ist $E = v_0 + U$, so ist $0 \neq w \in U^\perp$ ($\Leftrightarrow U = w^\perp$) und wählen wir $w \in U^\perp$ mit $\no{w}=1$ und $b > 0$ (durch die Wahl eines geeigneten Vorzeichens), so ist $b$ genau der Abstand von $E$ zu $0$, was man sich an folgender Skizze klarmacht: \todo{Skizze einfügen}
