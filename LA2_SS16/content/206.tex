...
\begin{anwendung}
	...
	Nach Satz~\ref{satz:6.11} genügt es dazu, alle orthogonalen Matrizen zu betrachten.
	
	Sei also $A = \begin{pmatrix}
	 a & b \\ c & d
	\end{pmatrix} \in \oh(2)$.
	Nach Satz~\ref{satz:6.9} ist dann $\penb{\binom{a}{b},\binom{c}{d}}$ eine Orthonormalbasis von $\RR^2$, das heißt es gilt
	\[
