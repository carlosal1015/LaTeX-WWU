...
\begin{beispiel}[Kegelschnitte, $n=2$]
	...
	\begin{enumerate}[(i)]
		...
		\missingfigure{Hier fehlt noch eine Grafik, die bislang nur mit \texttt{pstricks} angefertigt wurde, was bei einem PDF-Treiber nicht wirklich gut funktioniert \ldots im Notfall konvertiert man die per Hand in eine PDF, schön wäre das allerdings nicht}
