...
\begin{beweis}
	...
	\begin{enumerate}[(i)]
		...
		\]
		Nach Induktionsvoraussetzung ist $\{v_1,\dots,v_j\}$ ein Orthonormalsystem mit $\LH\{v_1,\dots,v_j\} = \LH\{w_1,\dots,w_j\} =: U_j$.
...
\begin{beispiel}
	...
	\begin{enumerate}[(i)]
		...
		\]
		eine Orthonormalbasis von $\RR^2$ bezüglich des Standard-Skalarprodukts. \todo{Skizze einfügen!}
