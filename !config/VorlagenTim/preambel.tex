...
\rohead{\includegraphics[height=0.6 cm,keepaspectratio]{../!config/Bilder/logo_AM.png}}
...
\hfill \includegraphics[height=1.3cm, keepaspectratio]{../!config/Bilder/logo_AM.png}}
\title{Skript \fach}
