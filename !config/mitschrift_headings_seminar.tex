...
\rehead{\rule{0cm}{0.6cm}\footnotesize\sffamily\color{light_gray}\verfasser{} -- \shortFach}
\lohead{\rule{0cm}{0.6cm}\footnotesize\sffamily\color{light_gray}as of \today \; \thistime[:]}
...
\title{\fach}
\subtitle{Synopsis of the seminar  \enquote{\fach} held by \prof}
