...
\ohead{\footnotesize \sffamily \color{light_gray} \includegraphics[height=0.5 cm, keepaspectratio]{../!config/Bilder/Logo_WWU_Muenster_light_gray.pdf}
	\vorlesung
...
\titlehead{\includegraphics[width=6cm, keepaspectratio]{../!config/Bilder/Logo_WWU_Muenster_light_gray.pdf}
			\hfill
			\includegraphics[width=7cm, keepaspectratio]{../!config/Bilder/fb10logo.pdf}}
\title{\vorlesung}
\subtitle{\subt}
