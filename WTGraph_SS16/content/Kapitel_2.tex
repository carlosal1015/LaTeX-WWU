...
\end{satz}
\begin{beweis}
	Nur der Anfang: Das Maximum existiert und wird angenommen. Die Menge aller Flüsse $\Theta \colon E \to \RR^+\subseteq \RR_+^{\abs{E}}$. Aus der Zulässigkeitsbedingung folgt \todo{missing part. letzten 3 sätze}
\end{beweis}
