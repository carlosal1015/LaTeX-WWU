...
Wie sampelt man die Gleichverteilung auf $\Omega$? \\
	...
	\underline{Mitteilung:} Ist $q > 2\Delta$, dann mischt die Kette in Zeit $\abs{V} \log \abs{V}$. Es kann aber auch schief gehen, wenn $\Delta$ groß wird. Sei dazu $G = (V,E)$ der $n$-Stern, d.h. $G$ ist ein Baum der Tiefe 1 mit Wurzel $v^*$ und $n-1$ Blättern. \todo{Stern bild}
	...
	\end{itemize}
	\todo{Layout überarbeiten}. Also gilt für 
	\begin{align}
