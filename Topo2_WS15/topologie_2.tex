...
\begin{beweis}
	...
	\]
	immer surjektiv ist nach \autoref{eig_kohomo_to_hom_homo} und in diesem Fall injektiv nach \cref{sub:paarung_isomorphismus_frei}\todo{leider gilt auch das nur für $\mathbb{Z}$ und dafür war es sowieso klar}, gibt es genau ein $\xi \in H^n \enbrace*{\mathbb{R}^n,\mathbb{R}^n \setminus B;R}$ mit $\xi(\mu_B)=1$. 
