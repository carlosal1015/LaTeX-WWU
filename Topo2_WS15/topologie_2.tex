...
\begin{lemma}[{name=[{Exaktheit vom Tensorieren und Hom}]}]
...
\begin{beweis}
	...
	\begin{enumerate}[(i)]
		...
		Wir erhalten also einen Homomorphismus $\psi \colon M'' \to W$, für den gilt\todo{Revision 12}
		\[
			\psi \circ g(m) = \psi' ([m]) = \varphi(m)
		\]
		Damit ist die Exaktheit gezeigt.\qedhere
	\end{enumerate}
\end{beweis}
