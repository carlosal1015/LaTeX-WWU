...
\end{proposition}
\begin{beweis}
	Nach \autoref{satz:spektralfolge_filtrierung} haben wir die folgenden Isomorphismen\marginnote{die horizontale Filtrierung unterscheidet sich quasi nur durch eine Spiegelung an der Diagonalen von der vertikalen Filtrierung}
	\[
