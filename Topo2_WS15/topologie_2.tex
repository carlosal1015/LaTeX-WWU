...
\begin{lemma}[label=projaufl:iso:hom,{name=[{Tensorieren mit projektiver Auflösung anstatt einem Rechtsmodul}]}]
...
\end{lemma}
\begin{beweis}
	\emph{Übungsaufgabe, ähnlich wie \autoref{projaufl:iso:hom}.}
\end{beweis}

\begin{bemerkung}[{name=[zu \autoref{projaufl:iso:hom}]}]
