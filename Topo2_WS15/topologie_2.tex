...
\begin{beispiel}[{name=[Tensorprodukt als Totalkomplex]}]
	...
	Definiert man eine zweite Art von Totalkomplex mit einem Produkt anstatt der Summe, lässt sich auch $\Hom(C_*,D_*)$ als Totalkomplex auffassen (siehe zum Beispiel \cite[V.1, S.~167ff]{HiltonHomAlg}).\todo{Revision 13}
\end{beispiel}

\begin{definition}[{name=[Filtrierung]}]
	Sei $C_*$ ein Kettenkomplex. Eine \Index{Filtrierung!Kettenkomplex} auf $C_*$ ist eine Folge 
	\[
