...
build:
	...
	docker run -it --rm -v $(CURDIR):/var/texlive  texlive sh -c "ls -a; echo \"\tikzexternaldisable\" >> \!config/mitschrift_headings.tex ; echo \"\tikzexternaldisable\" >> \!config/PhistScript.tex; ./compile_all.sh"
