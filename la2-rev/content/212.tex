...
\begin{beweis}[Satz~\ref{satz:12.14}]
...
Mit Hilfe von Satz~\ref{satz:12.16} erhalten wir insbesondere die folgende Dimensionsformel:
...
\begin{bemerkung}
	...
	Es folgt sofort aus Satz~\ref{satz:12.19}, dass die Hyperebenen gerade die Mengen der Form
	\[
