...
\subsection{Das charakteristische Polynom und Diagonalisierbarkeit}
\label{sec:2.2}
...
\begin{erinnerung}
	...
	\begin{enumerate}[(a)]
		...
		\item In Definition~\ref{def:I.16.21} hatten wir für einen Eigenwert $\lambda_i$ von $F$ die \Index{geometrische Vielfachheit} von $\lambda_i$ definiert durch die Dimension des Eigenraums: $\gamma(\lambda_i) := \dim(E_{\lambda_i}(F))$.
	\end{enumerate}
\end{erinnerung}
