...
\begin{beweis}
	...
	\begin{align*}
		...
		& \leq \frac{c}{r^{n+1}} \int_{B_r(x_0)}^{} \sup_{\mathbb{R}^n} \abs{u} \,\mathrm{d}x \\
		&\leq \frac{c}{r^{n+1}}\, \underset{\leq M}{\underbrace{\sup_{\mathbb{R}^n}\abs{u}}} \,\omega_n r^n \\
		&\leq \frac{c}{r}.
	\end{align*}
...
\begin{satz}[Greensche Darstellungsformel]
	...
	\end{equation}
	wobei $\Phi$ die Fundamentallösung der Laplace-Gleichung bezeichnet.
\end{satz}
