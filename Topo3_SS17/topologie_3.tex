...
\begin{beweis}
	...
	Es sei nun ein Homotopieerweiterungsproblem wie unten in braun gegeben.\todo{fertig machen}
	\[
		\begin{tikzcd}
			Y \times \set*{0} \dar \rar & P \times \set{0} \dar \ar[ddr,bend left] \\
	...
	\[
		...
		\end{tikzcd}
	\]
	Da (*) ein Pushout-Diagramm ist, existiert dazu eine Lösung $P \times I \to Z$.
