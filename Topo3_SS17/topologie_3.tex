...
\begin{definition}
	Für eine punktierte Abbildung $f \colon (X,x_0) \to (Y,y_0)$ definieren wir den \bet{reduzierten Abbildungszylinder}\index{Abbildungszylinder!reduzierter} und den \bet{reduzierten Abbildungskegel}\index{Abbildungskegel!reduzierter} durch
	\[
...
\begin{lemma}[{name=[Komposition von Kofaserungen]}]
...
\begin{definition}[{name=[koexakte Folge punktierter Abbildunge]}]
	Eine Sequenz von punktierten Abbildungen $A \to B \to C$ heißt \Index{koexakt}, wenn für jeden punktierten Raum $Y$ die Folge 
	\[
		\begin{tikzcd}
...
\begin{definition}
	Eine Sequenz von punkten stetigen Abbbildungen heißt \Index{koexakt}, falls je zwei aufeinander folgende Abbildungen koexakt sind. 
\end{definition}
...
\missingfigure{Kegeln macht Spaß}
...
\begin{satz}[name={Puppe}]
	...
	\]
	ist koexakt.
	Diese Sequenz heißt \Index{Puppe-Sequenz} (oder Barrett-Puppe-Sequenz).
\end{satz}


\newpage
\todo{an sinniger Stelle einfügen}
\begin{satz}
