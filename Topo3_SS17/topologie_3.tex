...
\begin{figure}
	...
	\begin{tikzpicture}[scale=.7]
		...
		\foreach \x in {0,1,2}{
			\draw[thick] ($(0,4) + (\x,.15)$) -- ++ (0,-0.3);
		}
		\draw[thick,Firebrick3] (0,4) -- ++ (1,0);
		\draw[thick,SpringGreen3] (1,4) -- ++ (1,0);
		\draw[-to, bend left] (3,4) -- ++ (2,0) node[midway,above]{$f * g$};
		
		\draw[thick] (6,4) .. controls +(80:1) and +(160:2) .. (9,5) 
		...
		\node at (1.5,-.5) {$g$};
		\draw[thick] (0,-1) grid (2,1);
		\draw[-to, bend left] (3,0) -- ++ (2,0) node[midway,above]{$f * g$};
		\draw[thick] (6,0) .. controls +(80:1) and +(160:2) .. (9,1) 
