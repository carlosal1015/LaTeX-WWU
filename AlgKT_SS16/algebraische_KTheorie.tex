...
\begin{beispiel}
    ...
    \begin{enumerate}[a)]
        ...
        \item Sei $I \subseteq R$ ein nichttriviales Ideal.
        Dann gibt es $c \in K \setminus R$ mit $c I \subseteq R$.
...
\begin{beweis}
    \begin{enumerate}[a)]
        ...
        Es folgt $(\alpha) \cap (\beta) \neq (0)$, denn sonst ist $(\alpha) \oplus (\beta) \subseteq (\alpha,\beta)$ ein Untermodul vom Rang 4.
        Sei $0 \neq r \in (\alpha) \cap (\beta)$, also $r = a \cdot \alpha = b \cdot \beta$ mit $a,b \in R$.
        Sei $c \coloneqq \frac{ab}{r} $.
        Dann ist $c \cdot I \subseteq R$.\todo{noch nicht ganz fertig}
        \item Sei $I \subseteq R$ ein Ideal.
