...
\begin{definition}
	Eine \Index{Waldhausen-Unterkategorie} $\mathcal{U}$ einer Waldhausen-Kategorie $\mathcal{C}$ ist eine Unterkategorie von $\mathcal{C}$ die auch eine Waldhausen-Kategorie ist, so dass gilt:
	\begin{enumerate}[i)]
...
\begin{bemerkung}
	Chirurgie kann nicht immer dazu verwendet werden, aus einer normalen Grad 1-Abbildung eine Homotopiäquivalenz zu machen.
