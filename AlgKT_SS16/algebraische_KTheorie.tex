...
\begin{bemerkung}
	...
	Ist $E$ ein endlicher CW-Komplex, so ist $C^\cell_*(\tilde{E})$ als $\mathbb{Z}\pi$-Kettenkomplex von endlichem Typ.
\end{bemerkung}
...
\begin{beweis}
	...
	\begin{enumerate}[(1)]
		...
		\item Die Inklusion $D_* \to C_*^\sing(\tilde{E})$ induziert einen Isomorphismus in Homologie.
