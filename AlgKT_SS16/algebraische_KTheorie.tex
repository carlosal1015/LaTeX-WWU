...
\begin{satz}[{name=[Approximationssatz]}]
	...
	\begin{enumerate}[(i)]
		...
		\item Ist $\beta$ in (ii) eine schwache Äquivalenz, so können wir $\alpha$ in (ii) als schwache Äquivalenz in $\mathcal{A}$ wählen.
	\end{enumerate}
...
\begin{beweis}
	...
	\emph{Behauptung:} $F$ induziert sogar einen Isomorphismus zwischen der Menge der schwachen Äquivalenzklassen in $\mathcal{A}$ und der Menge der schwachen Äquivalenzklassen in $\mathcal{B}$.\todo{muss noch bewiesen werden}
