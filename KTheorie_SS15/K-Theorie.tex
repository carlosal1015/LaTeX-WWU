...
\begin{enumerate}[a)]
	...
	\]
	exakt.
	\item \Index{Ausschneidung}: Sei $(X,A)$ ein Raumpaar, $U \subset A$, sodass $\overline{U} \subseteq \interior{A}$. Dann ist die von der Inklusion 
...
\begin{quote}
Sei $(X,A)$ ein Ko-Raumpaar und $U \subset A$ eine Teilmenge mit $\overline{U} \subset \interior{A}$. Dann ist die induzierte Abbildung 
...
Sei $(X,A)$ ein Ko-Raumpaar und $U \subseteq A$, sodass $\overline{U} \subset \interior{A}$, dann ist $K^{-n}(X,A) \to K^{-n}(X \setminus U, A \setminus U)$ ein 
Isomorphismus.	
\end{korollar}
\begin{beweis}
...
\]
als Ring, induziert durch $L \mapsto [L_n,0]_\st$
\minisec{Beweis}
